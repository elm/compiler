...
See the full outlines here:
  ...
  - `elm.json` for [applications](https://github.com/elm/compiler/blob/main/docs/elm.json/application.md)
  - `elm.json` for [packages](https://github.com/elm/compiler/blob/main/docs/elm.json/package.md)
